...
const CustomVideoPlayer: React.FC<CustomVideoPlayerProps> = ({
  ...
  return (
    <div
      ...
      className={cn(
        "relative bg-black overflow-hidden shadow-xl flex flex-col items-center justify-center",
        {
    ...
    >
      {thumbnail && showThumbnail && !playing && (
        <div
          className="absolute top-0 left-0 right-0 bottom-0 inset-0 bg-cover bg-center z-30 flex items-center justify-center w-full h-full aspect-video"
      ...
      <div
        ...
        className={cn("bg-blue-500 relative", {
          "w-full h-auto": isFullscreen && screen.width < screen.height,
          "w-auto h-full": isFullscreen && screen.width > screen.height,
        })}
      >
        <ReactPlayer
          ...
          onError={(e) => {
            console.error(e);
            setIsError(true);
            setError(e?.target?.error?.message ?? "An error occurred");
          }}
