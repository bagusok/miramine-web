...
export default async function LatestCompleted() {
  const anime = await getAnime(21, 0);

  return (
    <section className="mt-10">
      <div className="mb-6 flex justify-between items-end">
        <h3 className="text-xl font-semibold text-primary">Anime Selesai</h3>
        <Link
          href="/anime"
      ...
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-7 xl:grid-cols-8 gap-4 justify-start">
        {anime.map((episode) => (
